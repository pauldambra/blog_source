...
![a sequence diagram of the system so far](/images/current-sequence.jpg){:loading="lazy"}
...
![the new sequence diagram](/images/new-sequence.jpg){:loading="lazy"}
...
![a gif demoing API calls being translated to HTML](/images/live-demo.gif){:loading="lazy"}
...
![advice on twitter to not use cloudformation](/images/helpful-advice.png){:loading="lazy"}
...
![the aws bill for 6 cents](/images/bill.png){:loading="lazy"}
