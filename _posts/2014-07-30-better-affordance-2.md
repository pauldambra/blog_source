...
![pulsing affordance](/images/pulse.gif){: loading="lazy"}{:loading="lazy"}
...
![Editable indicator changing state](/images/affordance-with-state.gif){: loading="lazy"}{:loading="lazy"}
...
![editable indicator changing state after typing finishes](/images/affordance-with-delay.gif){: loading="lazy"}{:loading="lazy"}
...
This now captures the element that is being edited in the `el` variable and then passes a function to setTimeout which _when SetTimeout actually runs_ calls onContentEdited.
