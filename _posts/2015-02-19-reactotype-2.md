...
![screenshot of the web page](/images/reactotype_screenshot.png){: loading="lazy"}{:loading="lazy"}
...
![demo of the web page](/images/reactotype.gif){: loading="lazy"}{:loading="lazy"}
